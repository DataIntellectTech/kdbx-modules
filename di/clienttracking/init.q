/ di.clienttracking - track connected client sessions via di.torq.handlers connection-lifecycle events
\l ::clienttracking.q
...
/ evaluates each name; version stays in the export so di.torq.depcheck reads it from the export dict
