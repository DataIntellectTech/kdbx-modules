/ di.util.toml test fixtures (loaded by test.csv). di.util.toml is pure - no mocks needed; the TOML text is
...
fdeps:"# peer deps\n[dependencies]\n\"di.servers\" = \"0.3.0\"  # injected\n\"di.dbwrite\" = \"0.1.0\"";  / a di.torq.depcheck deps.toml
expdeps:`di.servers`di.dbwrite!("0.3.0";"0.1.0");   / di.torq.depcheck's readdeps expects [dependencies] -> symbol!version-string
