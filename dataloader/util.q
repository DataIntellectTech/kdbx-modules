/ function to apply attribute to a column
...
paramfilter:{[loadparams]
  ...
  reqtypes:`headers`types`tablename`dbdir`symdir`chunksize`partitioncol`partitiontype`gc!11 10 -11 -11 -11 -6 -11 -11 -1h;
