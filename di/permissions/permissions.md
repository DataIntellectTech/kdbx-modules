...
### LDAP coverage — the bind path is exercised via an injected `ldapbind`
...
> **⚠ Security note on the cache.** After a successful bind, a repeat login by the same user with the
